...
Перелік виправлень, зроблених у рамках Практичної роботи 4:

- `lab3/cli/src/main.rs` — форматування виводу тегів (join ", ").
- `lab3/core/src/store.rs` — перед записом JSON створюється батьківська директорія.

Після створення Issues/Pull Requests вставте сюди посилання на PR/commits.
# Fixes applied
